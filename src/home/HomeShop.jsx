  ...
  return (
    ...
    >
      <div className="relative sm:px-0 ">
        ...
        {/* Desktop: grid */}
        <div className="hidden sm:grid sm:grid-cols-3 gap-0 sm:mt-0 border-t-0 border-gray-300 px-3 pt-3 bg-gray-50">
          {shop.articles?.slice(0, 3).map((article, index) => (
            <img
              key={index}
      ...
      <div className="flex justify-between items-center sm:px-3 px-3 py-3 sm:py-3 sm:border-t border-gray-300 mt-3">
