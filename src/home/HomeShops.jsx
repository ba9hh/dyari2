...
const HomeShops = () => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-bottom relative bg-gray-100/90"
      ...
      <div>
        {data?.shops?.length > 0 ? (
          <div className="lg:grid-cols-2 md:grid-cols-2 grid grid-cols-1 sm:gap-x-12 sm:gap-y-12 sm:mx-2 sm:mt-6">
            {data?.shops?.map((shop) => (
