...
const ArticlesShop = ({ shopId }) => {
  ...
  return (
    <div className="w-full sm:w-2/3 bg-white shadow-md rounded-md pt-0 pb-0 sm:border-0 sm:border-t-0">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-x-2 gap-y-2 sm:px-0 mt-1">
