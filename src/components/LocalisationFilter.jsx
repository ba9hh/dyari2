  ...
  return (
    <>
      ...
      <div className="sm:flex justify-between py-3 px-8 hidden">
        <div className="flex items-center bg-white py-2 px-3 rounded-full border-2 gap-2">
        ...
        <select
          ...
          className="h-[36px] text-stone-600 text-[#1c1e21] rounded-[4px] px-[8px] pr-[20px] border border-stone-400 w-40 cursor-pointer"
        >
          {cities.map((city) => (
